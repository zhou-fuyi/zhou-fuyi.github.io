...
![价格方案](https://cdn.jsdelivr.net/gh/zhou-fuyi/images/knowledge-base/20220420230608.png)

#### 和风天气

几乎可以免费使用其提供的所有 API，且同样支持经纬度方式进行天气查询。

![价格方案](https://cdn.jsdelivr.net/gh/zhou-fuyi/images/knowledge-base/20220420230832.png)

![商业版与开发版的区别](https://cdn.jsdelivr.net/gh/zhou-fuyi/images/knowledge-base/20220420230608.png)
...
![H5+Javascript技术结构图](https://cdn.jsdelivr.net/gh/zhou-fuyi/images/knowledge-base/Front_End.png)
...
![关于小程序WebView的说明](https://cdn.jsdelivr.net/gh/zhou-fuyi/images/knowledge-base/20220420232504.png)

### UI

UI部分参考和风天气APP，以及[WEUI](https://developers.weixin.qq.com/miniprogram/dev/platform-capabilities/extended/weui/)

![和风天气APP主页-1](https://cdn.jsdelivr.net/gh/zhou-fuyi/images/knowledge-base/20220420232553.png)

![和风天气APP主页-2](https://cdn.jsdelivr.net/gh/zhou-fuyi/images/knowledge-base/20220420232553.png)
